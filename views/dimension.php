             ...
             <table id="example1" class="table table-striped">
               ...
               <tbody>
                ...
                foreach($dimension as $value) {
                  ...
                  <button type="button" class="btn-xs btn-danger" idDimension="'.$value["id_dimension"].'"> <i class="fas fa-lock"></i></button></td>';
                  echo "</tr>";
   ...
   <div class="modal-dialog">
     <div class="modal-content">
       ...
       <div class="modal-header bg-primary">
         <h4 class="modal-title">Dimen <i class="fas fa-plus"></i></h3>
