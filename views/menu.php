<doctype html>
    ...
    <head>
        ...
        <link rel="icon" type="image/png" href="images/logoeste.ico"/>
        ...
        <!--Ionic icons-->
        <link href="https://unpkg.com/ionicon@4.5.5/dist/css/ionicons.min.css" rel="stylesheet">
        <!--Favicon-->
        <link rel="icon" type="image/png" href="assets/images/logoeste.ico"/>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                <img src="assets/images/ojalaestesi2.png" class="logo-brand" alt="logo" width="600px">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="portfolio-container">
                            <img src="../assets/images/ejemplo.jpg" class="img-fluid" alt="Portfolio 01"> 
                        </div>                     
                    </div>
                </div>
            </div>
        ...
        <section id="contact" class="divider" style="background-color:#C5D8D8">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="portfolio-container">
                            <img src="assets/images/estu.jpg" class="img-fluid" alt="Portfolio 01"> 
                        </div>                     
                    </div>
                    <div class="col-md-6">
                        <div class="pricing-container">
            ...
            <div class="container footer-top">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4 footer-widget">
                        <div class="about-widget" >
                            <ul class="contact"  align="left">
                               <br>
                               <p><img src="assets/images/correo.PNG" width="45" height="40">Correo: lafuente@gmail.com </p>
                               <p><img src="assets/images/ubicación.PNG" width="40" height="40">Dirección: Vereda La Fuente </p>
                               <p><img src="assets/images/telefono.PNG" width="40" height="40">Teléfono: 311 2349531</p>
                            </ul>
                        </div>
                    </div>
                    <!-- widget -->
                    <div class="col-sm-6 col-lg-4 footer-widget">
                      <br>
                           <center>
                            <img src="assets/images/logo.png" class="logo-brand" alt="logo" width="130px" height="130px"></center>  
                      </div>
                    <!-- widget -->
                    <div class="col-sm-6 col-lg-4 footer-widget">
                        <ul class="contact"  align="left">
                          <br>
                            <p> <img src="assets/images/rural.PNG" width="40" height="40" >Área: Rural </p>
                            <p><img src="assets/images/publico.PNG" width="40" height="40">Carácter: Pública </p>
                            <p><img src="assets/images/jornada.PNG" width="40" height="40">Jornadas: Jornada diurna</p>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <script type="assets/js/Indexvali.js"></script>
    </body>
</html>